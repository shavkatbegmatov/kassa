...
<html>
	<head>
		...
		<!-- styles -->
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/layerslider.css">
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/skin.css">
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/font-awesome.css">
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/owl.carousel.css">
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/jquery.fancybox.css">
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/styles.css">
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/color-blue.css">
		<link rel="stylesheet" type="text/css" href="/css/clinico/css/styles (1).css">
				...
				<div class="sticky-wrapp">
					<div class="sticky-container">
						...
						<section id="logo" class="logo">
							<div>
								<a href="index.html"><img src="img/blue/logo.png" width="190" height="50" alt="Clinico"></a>
							</div>
						</section>
						<!--/ logo -->
							...
							<ul>
								<li>
									...
									<ul>
										...
										<li><a href="home-one-page.html" class="active">Home Alternative</a></li>
									</ul>
								</li>
								<li>
			...
			<main class="page-content">
						...
						<div class="callout wpb_content_element">
							...
							<div class="callout-wrapper">
								<div class="callout-content">
									<div class="title">Grab this template now!</div>
									<div class="subtitle">Morbi justo dolor, auctor non ornare quis, bibendum ut nibh.</div>
								</div>
				...
				<div class="grid-row">
						...
						<section class="detailed-services wpb_content_element">
							...
							<dl>
								<dt id="service4" class="opened"><i class="fa fa-check"></i>Adolescent Gynecology</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											...
											<div class="clearfix">
												...
												<ul>
													<li>Doctors:</li>
													<li>Elizabeth K.</li>
													<li>Charles W. Andrias</li>
													<li>Vincent J. Antonelli</li>
												</ul>
												<ul>
													<li>Hours:</li>
													<li>8am - 5pm</li>
												...
												<div class = "call-to">
													<a class="wpb_button_a" href="#">
														<span class="wpb_button wpb_btn-alt wpb_regularsize"> make an appointment </span>
													</a>
												</div>
											</div>
										</div>
								...
								<dt id="service6"><i class="fa fa-check"></i>Aging (Geriatrics)</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
								...
								<dt id="service7"><i class="fa fa-check"></i>Anesthesiology</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
								...
								<dt id="service8"><i class="fa fa-check"></i>Breast Center</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
								...
								<dt id="service9"><i class="fa fa-check"></i>Cancer (Oncology)</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
								...
								<dt id="service10"><i class="fa fa-check"></i>Children (Pediatrics)</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
								...
								<dt id="service11"><i class="fa fa-check"></i>Critical Care Units (ICU, NICU, Intermediate Care)</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
								...
								<dt id="service12"><i class="fa fa-check"></i>Dentistry</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
								...
								<dt id="service13"><i class="fa fa-check"></i>Diabetes, Glands (Endocrinology)</dt>
								<dd>
									<div class="details">
										<div class="clearfix">
											<img src="pic/services-1.png" width="185" height="110" alt="">
				...
				<div class="grid-row">
					...
					<section class="timetable">
						<div class="widget-title">Timetable</div>
						
						<select class="filter">
							<option value="">All Departments</option>
							<option value="">Pediatric Clinic</option>
							<option value="">Gynaecological Clinic</option>
							<option value="">Laryngological Clinic</option>
						...
						<header>							
							...
							<div class="day">
								<input type="text" value="10/10/13">
							...
							<div class="switcher">
								<a href="timetable-month.html"><i class="fa fa-calendar"></i></a>
								<a href="timetable-week.html"><i class="fa fa-calendar-o"></i></a>
								<a href="timetable-list.html" class="active"><i class="fa fa-list"></i></a>
							</div>
						</header>
						...
						<table class="list-view">
							...
							<tr>
								<td>
									<i class="fa fa-clock-o"></i>03:00 PM<br>10/10/2014
								</td>
								<td>
									<i class="fa fa-clock-o"></i>05:00 PM<br>10/10/2014
								</td>
								<td class="event-container">
									<div class="event">
										<div class="title"> Pellentesque erat lorem, mattis</div>
										<p>Proin quis molestie mauris. Etiam nec orci mauris. Aenean cursus tellus nisi, in fermentum risus venenatis vel. Vivamus at metus placerat diam accumsan pulvinar. Donec at condimentum tortor. Maecenas tincidunt consectetur vulputate. In rhoncus metus a erat gravida dapibus at non lorem. Donec nec vulputate elit. Cras tempus ipsum vel tortor eleifend commodo. Cras condimentum risus at metus dictum viverra.</p>
										<div class="popup">
											<p>•&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer a malesuada mi. Sed sollicitudin at arcu eget interdum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed blandit venenatis mi, vel gravida leo facilisis eu.<br><br>•&nbsp; Etiam ipsum dui, porta euismod pretium non, vestibulum eget felis. In non ligula nisl. Donec vehicula orci id commodo pretium. Interdum et malesuada fames ac ante ipsum primis in faucibus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
											<a href="#"><span></span></a>
										</div>
										<a href="#"><span></span></a>
									</div>
							...
							<tr>
								<td>
									<i class="fa fa-clock-o"></i>04:00 PM<br>10/10/2014
								</td>
								<td>
									<i class="fa fa-clock-o"></i>05:00 PM<br>10/10/2014
								</td>
								<td class="event-container">
									<div class="event">
										<div class="title">Aenean semper sagittis facilisis.</div>
										<p> Mauris in rhoncus nunc, nec scelerisque orci. Curabitur in egestas dolor, a faucibus dui. Nunc sollicitudin pellentesque nulla, a condimentum mi ultricies ac. Pellentesque ullamcorper justo quis est cursus blandit. Sed libero neque, condimentum sed sagittis quis, molestie et elit. Integer nec felis ac orci tempor sodales at eget purus. Nunc lobortis urna sit amet nisi sollicitudin venenatis. Nam congue arcu.</p>
										<div class="popup">
											<p>•&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer a malesuada mi. Sed sollicitudin at arcu eget interdum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed blandit venenatis mi, vel gravida leo facilisis eu.<br><br>•&nbsp; Etiam ipsum dui, porta euismod pretium non, vestibulum eget felis. In non ligula nisl. Donec vehicula orci id commodo pretium. Interdum et malesuada fames ac ante ipsum primis in faucibus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
											<a href="#"><span></span></a>
										</div>
							...
							<tr>
								...
								<td>
									<i class="fa fa-clock-o"></i>06:00 PM<br>10/10/2014
								</td>
								<td class="event-container">
									<div class="event">
										<div class="title">Vivamus dictum pellentesque sollicitudin</div>
										<p>Donec urna lectus, blandit vitae lorem quis, tincidunt feugiat lacus. Aliquam at erat porta, sagittis arcu quis, lacinia ligula. Nullam vel leo venenatis purus pulvinar accumsan et sed neque. Proin eget libero in eros feugiat semper sed in dolor. Donec imperdiet non neque ut suscipit. Ut varius nulla nec consectetur.</p>
										<div class="popup">
											<p>•&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer a malesuada mi. Sed sollicitudin at arcu eget interdum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed blandit venenatis mi, vel gravida leo facilisis eu.<br><br>•&nbsp; Etiam ipsum dui, porta euismod pretium non, vestibulum eget felis. In non ligula nisl. Donec vehicula orci id commodo pretium. Interdum et malesuada fames ac ante ipsum primis in faucibus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
											<a href="#"><span></span></a>
										</div>
						...
						<div class="mobile-view">
							<dl>
								...
								<dd>
									<ul>
										<li><i class="fa fa-clock-o"></i><span>06.00 - 07.00</span>Pain Management, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>07.00 - 08.00</span>Radiation Oncology, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>10.00 - 11.00</span>Infectious Diseases, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>15.00 - 18.00</span>Emergency Department, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>19.00 - 20.00</span>Emergency Department, John Franklin</li>
									</ul>
								</dd>
								<dt><span>Tuesday</span></dt>
								<dd>
									<ul>
										<li><i class="fa fa-clock-o"></i><span>07.00 - 08.00</span>Infectious Diseases, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>09.00 - 10.00</span>Pain Management, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>12.00 - 13.00</span>Radiation Oncology, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>15.00 - 18.00</span>Emergency Department, John Franklin</li>
										<li><i class="fa fa-clock-o"></i><span>19.00 - 20.00</span>Emergency Department, John Franklin</li>
									</ul>
								</dd>
				...
				<div class="grid-row">					
								...
								<section id="news" class="widget news news-3">
									...
									<div class="owl-carousel" id="news-carousel-3">
										<div class="item">
											<div class="date">20 AUG 2014<i class="fa fa-comment"><span>3</span></i></div>
											<div class="pic">
											...
											<h3><a href="#">Nullam euismod commodo</a></h3>
											<p>Mauris vitae quam quam. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer ullamcorper ultricies eros eu consequat. Nullam convallis volutpat nunc, gravida vestibulum mauris interdum et. Nunc tristique eros nec dictum blandit. Cras eu turpis augue. Ut non molestie nulla. Nulla nec rutrum tortor, in fermentum nisl <a href="#">&rarr;</a></p>
											<div class="cats">Posted in: <a href="#">Dental Clinic</a>, <a href="#">General</a>, <a href="#">News</a></div>
										</div>
										
										<div class="item">
											<div class="date">15 AUG 2014<i class="fa fa-comment"><span>1</span></i></div>
											<h3><a href="#">Quisque venenatis mi at</a></h3>
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec lectus orci. Nunc suscipit quis mauris non pellentesque. Cras at augue dui. Vestibulum mollis cursus orci ut laoreet. Duis accumsan accumsan adipiscing. Mauris tincidunt a lacus nec pretium  <a href="#">&rarr;</a></p>
											<div class="cats">Posted in: <a href="#">Dental Clinic</a>, <a href="#">General</a>, <a href="#">News</a></div>
										</div>
										
										<div class="item">
											<div class="date">11 AUG 2014<i class="fa fa-comment"><span>3</span></i></div>
											<div class="pic">
											...
											<h3><a href="#">Quisque venenatis mi</a></h3>
											<p>Mauris vitae quam quam. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer ullamcorper ultricies eros eu consequat <a href="#">&rarr;</a></p>
											<div class="cats">Posted in: <a href="#">Dental Clinic</a>, <a href="#">General</a>, <a href="#">News</a></div>
										</div>
				...
				<div class="grid-row">
							<div class="testimonial">
								<div class="clearfix">
									...
									<p>Sed purus purus, tincidunt eget malesuada et, molestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur, ligula tellus pulvinar. Urna, quis facilisis magna dolor ac lacus. Mauris congue nec nisi sit amet malesuada. Vivamus sodales nunc et pulvinar bibendum. Morbi quis erat non odio suscipit imperdiet quis quis nisl. Pellentesque imperdiet lectus vel aliquet consequat. Donec commodo, tellus vel consectetur commodo, arcu magna ornare felis, et malesuada leo erat id leo. In bibendum, ipsum eu imperdiet scelerisque, elit neque auctor ante, eu pellentesque magna erat quis massa.</p>								
								</div>
